...
export default class SwipeCards extends Component {
  ...
  renderStack() {
    ...
    let cards = this.state.cards.slice(currentIndex[ this.guid ], currentIndex[ this.guid ] + this.props.stackDepth)
      .reverse()
    ...
    return cards.map((card, i) => {
      ...
      return <Animated.View key={card[ this.props.cardKey ]}
                            style={style}>{this.props.renderCard(card)}</Animated.View>
    })
  }
